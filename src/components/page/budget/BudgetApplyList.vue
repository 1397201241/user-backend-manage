<template>
    <el-container style="width: 1280px;height: 560px;padding:-30px -150px -150px -30px" direction="vertical">
        <el-divider content-position="left"><span style="color: red;font-size: large">项目预算申报列表</span></el-divider>
        <el-card style="width: 100%">
            <el-table
                ...
                <el-table-column
                        ...
                        width="200">
                    <template>
                        <el-button type="primary" size="mini" @click="Note">提交申报</el-button>
