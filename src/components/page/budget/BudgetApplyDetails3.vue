            ...
            <el-form ref="elForm" :model="formData" :rules="validateRules" label-width="80px"
                ...
                <el-container>
                    <el-form-item label="部门建议" prop="PRO_DEPREVIEW" style="width: 100%">
                        <el-input v-model="formData.PRO_DEPREVIEW" placeholder="请填写部门建议" disabled>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="预批复数" prop="REPLY_AMT" style="width: 100%">
                        <el-input  v-model="formData.REPLY_AMT" placeholder="请填写预批复数" disabled>
                        </el-input>
                    </el-form-item>
                </el-container>
                <el-container>
                    <el-form-item label="财政建议" prop="PRO_BGTREVIEW" style="width: 100%">
                        <el-input v-model="formData.PRO_BGTREVIEW" placeholder="请填写财政建议">
                        </el-input>
                    </el-form-item>
                </el-container>
                <el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            addSuggest(){
                this.formData.PRO_BGTREVIEW='建议通过！'
            }
        }
    }
</script>
