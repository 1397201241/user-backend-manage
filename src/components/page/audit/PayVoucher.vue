<template>
    <el-container style="padding:-30px -150px -150px -30px" direction="vertical">
        <el-divider content-position="left"><span style="color: red;font-size: large">支付凭证清单（财政部门）</span></el-divider>
        <!--支付凭证清单-->
        <el-table
                :show-header='false'
                :data="payData"
        ...
        <el-divider content-position="left"><span style="color: red;font-size: large">支付凭证汇总信息（代理银行）</span></el-divider>
        <!--划款申请清单-->
        <el-table
                :show-header='false'
                :data="data"
        ...
        <el-dialog
            ...
            <el-button style="margin-top: 15px" type="primary" @click="send2">
                <i class="iconfont icon-fasong"></i>
                发送清算银行</el-button>
        </el-dialog>
