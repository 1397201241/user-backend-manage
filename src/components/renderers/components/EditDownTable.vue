<template>
  <div class="edit-down-table">
    <vxe-pulldown class="edit-down-pulldown" ref="xDown" transfer>
      <template>
        <vxe-input class="edit-down-input" v-model="row[column.property]" suffix-icon="iconfont icon-xiala" @keyup="keyupEvent" @click="clickEvent" @suffix-click="suffixClick"></vxe-input>
      </template>
      <template #dropdown>
...
@import "https://at.alicdn.com/t/font_2666070_ileemx380x.css?spm=a313x.7781069.1998910419.39&file=font_2666070_ileemx380x.css";
.edit-down-pulldown {
  width: 100%;
}
.edit-down-wrapper {
